...
async function loadInvoices() {
    ...
    const allInvoicesData = await response.json();
    ...
    allInvoices = allInvoicesData.filter(invoice => {
    ...
    const excludedCount = allInvoicesData.length - allInvoices.length;
    console.log(`✅ Facturas cargadas (optimizadas): ${allInvoices.length}`);
